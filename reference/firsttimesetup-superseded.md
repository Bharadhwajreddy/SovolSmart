...
```bash
git clone https://github.com/vallabh2504/LifeOS.git
cd LifeOS && git checkout claude/sovol-sv02-web-app-6sb940 && cd printer
npm install
```
...
git clone https://github.com/vallabh2504/LifeOS.git
cd LifeOS
git checkout claude/sovol-sv02-web-app-6sb940
cd printer
npm install
```
...
```
User=pi
WorkingDirectory=/home/pi/LifeOS/printer
```
